    ...
    es: {
      ...
      hero: {
        title: (
          <>
            {" "}
            Diseñamos con <strong>propósito</strong>, desarrollamos con{" "}
            <strong>precisión</strong>
          </>
        ),
        description: (
          <>
            Desde la conceptualización hasta el lanzamiento, nos enfocamos en la
            calidad, la innovación y la excelencia técnica. Sumate a la
            evolución digital con soluciones a medida que potencian tu negocio.
          </>
        ),
        tags: [
          "Desarrollo web",
    ...
    en: {
      ...
      hero: {
        title: (
          <>
            {" "}
            We design with <strong>purpose</strong>, develop with{" "}
            <strong>precision</strong>
          </>
        ),
        description: (
          <>
            From conceptualization to launch, we focus on quality, innovation,
            and technical excellence. Join the digital evolution with custom
        ...
        items: [
          {
            ...
            description:
              "Modern and responsive websites with the latest technologies",
          },
          {
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-gray-200 text-sm">
              <span>CABA</span>•<span> Córdoba</span>•
              <span>Comodoro Rivadavia</span>•<span> Mar del Plata</span>
            </div>
          </div>
